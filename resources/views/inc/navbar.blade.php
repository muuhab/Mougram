<!-- Navigation -->
<nav class="navbar navbar-expand-lg  border-bottom rounded-bottom bg-white fixed-top ">
  <div class="container">
    <a class="navbar-brand" href="{{route('dashboard')}}"><i class="fas fa-camera-retro text-primary"></i> {{config('app.name')}}</a>
